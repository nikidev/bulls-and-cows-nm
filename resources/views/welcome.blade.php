        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    @if (Route::has('login'))
                        @auth
                            <div class="p-6 flex justify-center uppercase">
                                <a href="{{ url('/dashboard') }}" class="text-2xl text-gray-700 dark:text-gray-500 underline">Go back to the playground</a>
                            </div>
                        @else
                                ...
                                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                    <div class="flex justify-center uppercase">
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}" class="text-2xl text-gray-700 dark:text-gray-500 underline">Register</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
